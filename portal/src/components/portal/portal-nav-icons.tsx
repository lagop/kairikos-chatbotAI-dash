...
export const ICON_BY_HREF: Record<string, ReactNode> = {
  ...
  '/portal/llamadas': (
    <svg {...ICON_PROPS}>
      <path
        d="M6.5 3.5l2.2 4-1.8 1.8a12 12 0 006.8 6.8l1.8-1.8 4 2.2v3.2a1.5 1.5 0 01-1.7 1.5C10.4 20.4 3.6 13.6 2.8 5.2A1.5 1.5 0 014.3 3.5h2.2z"
  ...
  '/portal/seo': (
    <svg {...ICON_PROPS}>
      ...
      <path d="M15 15l5 5" />
      <path d="M7.5 11.5l1.6-2.2 1.4 1.2 2-2.7" />
    </svg>
  ),
  '/portal/resenas': (
    <svg {...ICON_PROPS}>
