...
// =============================================================================
// Canales — POST /api/internal/channels/instagram/message
//
// Mirror of .../messenger/message, same inactivity-bounded session logic.
// =============================================================================
...
export async function POST(req: NextRequest) {
  ...
  const now = new Date();
  const sessionPrefix = `instagram-${body.data.senderId}-`;
