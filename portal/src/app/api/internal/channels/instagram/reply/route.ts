...
// =============================================================================
// Fase 1.2 — POST /api/internal/channels/instagram/reply
//
...
//
// El clientId se resuelve desde el igUserId de la conexión, nunca del cuerpo.
// =============================================================================
...
export async function POST(req: NextRequest) {
  ...
  const result = await replyToIncomingMessage(prisma, {
    ...
    channel: 'instagram',
    key: { kind: 'inactivity', sessionPrefix: `instagram-${body.data.senderId}-` },
